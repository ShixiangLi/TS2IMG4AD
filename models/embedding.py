...
class Embedding2D(nn.Module):
    def __init__(self, in_channels, d_model, dropout=0.0, h=16, w=16, ref_len=1, with_pos_embed=True, device=torch.device('cuda')):
